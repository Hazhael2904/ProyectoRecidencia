<?php
     ...
     if(isset($_POST['guardar'])){
          ...
          if(!empty($id_solicitud) && !empty($respuesta) && !empty($fechactualizacion) && !empty($idusuarios) && !empty($estatus) ){
          	$consulta_insert=$con->prepare('INSERT INTO respuesta_solicitud(id_solicitud,respuesta,fechactualizacion,idusuarios,estatus) VALUES(:id_solicitud,:respuesta,:fechactualizacion,:idusuarios,:estatus)');
