	...
	<div class="contenedor">
		...
		<div class="barra__buscador">
			<form action="" class="formulario" method="post">
				...
				<a href="guardarproyecto.php" class="btn btn__nuevo">Nuevo Proyecto</a>
			</form>
			<table>
				<tr class="head">
					<td>ID</td>
				...
				if( !$consulta=$con->query($query) ){
					...
					while ($fila=$consulta->fetch(PDO::FETCH_ASSOC) )
					{
						...
						<tr>
							...
							<td><a href="deleteproyecto.php?id_proyectos=<?php echo $fila['id_proyectos'];?>" class="btn btn_delete">Delete</a></td>
						</tr>
						<?php
					}
				}
