...
switch ($accion) {
	...
	$sentanciaSQL = $pdo->prepare("INSERT INTO
		eventos(title,descripcion,usuarios,color,personal,servicio,textColor,start,end)
		VALUES(:title,:descripcion,:usuarios,:color,:personal,:servicio,:textColor,:start,:end)");
